  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit} className={`${className} account-information-form`}>
        ...
        <Field className="account-information-form__change-password" onClick={() => console.log("tryna show passwords")} type="button" labelTitle="Password" title="Change Password" name="change-password" component={LongGrayButton} />
      </form>
    );
  }
}
